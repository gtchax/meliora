...
return array(
	...
	'required_msg' => esc_attr__('Please insert email','suarez'),	//message displayed when at least one required filed is not filled
	'invalid_email_class' => 'invalid_email',	//class added to the email input with an invalid email value at submission
	'invalid_email_msg'=> esc_attr__("Invalid Email",'suarez'),	//Invalid email message
	...
	'date_headline' => esc_attr__('Date','suarez'),
	'no_data_posted' => esc_attr__('No data received','suarez'),
	'error_open_create_files_msg' => esc_attr__('Error writing to disk','suarez'), //leave blank to get the php error msg
	'success_msg' => esc_attr__('Successfully Subscribed','suarez'),
	'error_writing_msg' => esc_attr__("Couldn't write to file",'suarez'),
